...
#define ADJUSTMENT MO(_ADJUSTMENT)
...
[_QWERTY] = LAYOUT_all(
   ...
   KC_DEL,  KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC, KC_ENT,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
ADJUSTMENT, KC_LCTL, KC_LALT, KC_LGUI, LOWER,   KC_SPC, _______,  KC_SPC,  RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_LOWER] = LAYOUT_all(
  ...
  _______, RGB_TOG, RGB_MOD, RGB_VAI, _______, _______, _______, _______, _______, KC_MNXT, KC_VOLD, KC_VOLU, KC_MPLY
),
...
[_ADJUSTMENT] =  LAYOUT_all(
  ...
  _______, RGB_TOG, RGB_MOD, RGB_VAI, _______, _______, KC_DEL, _______, _______, _______, _______, _______, _______
)
};

layer_state_t layer_state_set_user(layer_state_t state) {
    return update_tri_layer_state(state, _LOWER, _RAISE, _ADJUSTMENT);
}
